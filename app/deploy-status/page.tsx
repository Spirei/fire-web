  ...
  return (
    <main className="min-h-screen bg-slate-50 px-5 py-10 text-slate-900 transition-colors dark:bg-[#0b0f16] dark:text-slate-100 sm:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        <section className="mb-6 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-[#121923] dark:shadow-none"><h2 className="mb-4 text-sm font-medium">发布流程</h2><div className="flex flex-wrap items-center gap-2 text-xs"><span className="rounded-lg border border-slate-300 px-3 py-2 text-slate-700 dark:border-slate-700 dark:text-slate-300">本地 main</span><span className="text-slate-400 dark:text-slate-600">→</span><span className="rounded-lg border border-slate-300 px-3 py-2 text-slate-700 dark:border-slate-700 dark:text-slate-300">安全 / 类型检查</span><span className="text-slate-400 dark:text-slate-600">→</span><span className="rounded-lg border border-blue-300 bg-blue-50 px-3 py-2 text-blue-700 dark:border-blue-400/40 dark:bg-blue-400/10 dark:text-blue-200">每日 00:00 或手动</span><span className="text-slate-400 dark:text-slate-600">→</span><span className="rounded-lg border border-slate-300 px-3 py-2 text-slate-700 dark:border-slate-700 dark:text-slate-300">构建 GHCR</span><span className="text-slate-400 dark:text-slate-600">→</span><span className="rounded-lg border border-emerald-300 bg-emerald-50 px-3 py-2 text-emerald-700 dark:border-emerald-400/40 dark:bg-emerald-400/10 dark:text-emerald-200">线上容器</span></div><p className="mt-3 text-xs text-slate-500">手动推送只发布 main 当前最新提交；提交本身不会自动打断线上版本。</p></section>
