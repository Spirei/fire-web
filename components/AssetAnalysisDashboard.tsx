    ...
    <div ref={splitRef} className="asset-analysis-split" style={{ "--asset-left-pct": `${leftPanePct}%` } as React.CSSProperties}>
      ...
      <main className="space-y-4">
        ...
        <section className="card overflow-hidden">
          ...
          {holdingPageCount > 1 && <div className="border-t border-edge bg-bg-gray/50 px-4 py-3"><div className="mb-2 text-center text-xs text-muted">共 {visiblePositions.length} 项 · 每页 {HOLDINGS_PAGE_SIZE} 项</div><Pagination page={safeHoldingPage} total={holdingPageCount} onChange={setHoldingPage} /></div>}
        </section>
