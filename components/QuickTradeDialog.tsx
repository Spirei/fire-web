...
export default function QuickTradeDialog({ open, record, initialSide, initialQty, intent = "trade", livePrice, maxBuyPower = 0, dayChange = 0, stockIcons, onClose, onDone }: Props) {
