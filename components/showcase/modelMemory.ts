 ...
 */
export function budgetImageDecoding(parser: GLTFParser, limit: number, current: () => boolean, onError?: (error: unknown) => void, yieldBetweenImages = false, onSourceSize?: (size: number) => void, onDecoded?: (done: number) => void) {
