...
export const MCL35M_SHOWCASE: ShowcaseConfig = {
  ...
  camera: {
    ...
    keyframes: [
      ...
      { p: 0.62, az: 180, r: 10.4, h: 2.0, ty: 0.72, tz: 0, tx: 0, fov: 31 },  // 抬升并收到车尾正后方（与光条汇聚点对齐）
      // 发车位：车尾正后方的低机位，按住空格后车就是朝这里驶入隧道，镜头保持锁定
      { p: 0.7, az: 196, r: 10.0, h: 2.4, ty: 0.78, tz: -0.2, tx: 0, fov: 32 },
      { p: 0.8, az: 202, r: 9.8, h: 2.6, ty: 0.8, tz: -0.1, tx: 0, fov: 32 },
  ...
  speed: {
    ...
    tunnel: {
      ...
      bars: [
        ...
        { angle: 59, width: 0.62, tone: "gold" },    // 外道 · 浅黄
        { angle: 317, width: 0.55, tone: "gold" },  // 外道 · 浅黄
        { angle: 239, width: 0.58, tone: "gold" },  // 外道 · 浅黄
        { angle: 296, width: 0.55, tone: "gold" },  // 外道 · 浅黄
        { angle: 112, width: 0.50, tone: "white" },  // 内道 · 浅蓝
        { angle: 268, width: 0.52, tone: "white" }  // 内道 · 浅蓝
      ]
    }
  },
