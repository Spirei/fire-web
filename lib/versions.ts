...
export const V0_1_19_ENTRY: VersionEntry = {
  ...
  changes: [{
    ...
    desc: "发布状态页新增最近一年 GitHub 风格更新热力图，固定显示 1–12 月且在容器内自适应不产生横向滚动；支持每日、每周、每月、累计视图，点击色块显示对应日期/周期的 workflow 次数，更新越多绿色越深；镜像构建成功且确认有新镜像后自动倒计时 5 分钟触发 Watchtower 容器更新；立即构建改为舒缓绿色呼吸圆点，手机端工具按钮右对齐；页面增加服务端管理员守卫，非管理员统一返回 404。",
    kind: "feature"
  }, {
