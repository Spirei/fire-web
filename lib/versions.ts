...
export const CURRENT_VERSION_ENTRY: VersionEntry = {
  ...
  changes: [{
    ...
    title: "账户助手入口改为青绿色",
    desc: "右下角账户助手入口使用由明亮青绿到深青绿的渐变，增加同色系细边框与柔和阴影；悬停时颜色轻微提亮并加强阴影，深浅主题保持白色图标和清晰对比。助手面板继续使用中性色，避免大面积彩色干扰账户内容。",
    kind: "fix"
  }, {
    title: "账户助手面板统一青绿色视觉",
    desc: "打开助手后的标题头像、用户消息、发送按钮与思考动画统一使用入口同款青绿色。头像和发送按钮沿用渐变、细边框与轻阴影，用户消息使用对比稳定的深青底色；交易确认及撤销继续保持中性按钮，确保关键操作层级清楚。",
    kind: "fix"
  }]
};
