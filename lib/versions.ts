...
export const V0_1_19_ENTRY: VersionEntry = {
  ...
  changes: [{
    ...
    desc: "定位资产分析持仓表虽有 overflow-x 但触摸手势被外层分栏接管的问题；新增全站 data-table-scroll 手势规范与 pan-x 惯性滚动，覆盖持仓、自选、全球排行、FIRE、日志、API 文档及所有 overflow-x-auto 区域；首页 Grid 伪表格同步设置完整最小宽度。",
    kind: "fix"
  }]
};
